...
const CATEGORY_LABELS: Record<string, { title: string; description: string }> = {
  ...
  'ai-detection': {
    title: 'AI Detection',
    description: 'Detect AI-generated text and images from ChatGPT, Gemini, Claude, and other AI models.',
  },
  'ai-humanizer': {
    title: 'AI Humanizers',
    description: 'Humanize AI-generated content for blogs, emails, social media, creative writing, and more.',
  },
  'watermark': {
    title: 'AI Watermark Tools',
    description: 'Detect and remove AI watermarks from images and videos generated by Gemini, DALL-E, Midjourney, and others.',
  },
  'seo-tool': {
    title: 'SEO & Rank Tracking',
    description: 'Track your brand visibility in AI answers, rank trackers for ChatGPT, Gemini, Claude, and Perplexity.',
  },
  text: {
    title: 'Text Tools',
