  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <textarea value={input} onChange={e => setInput(e.target.value)} rows={6} placeholder="Paste your text here..." className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-blue-500" />
      </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {results.slice(0, 50).map(([word, count]) => {
                  ...
                  return (
                    <tr key={word} className="border-b border-slate-100 last:border-0">
