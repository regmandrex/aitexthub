    ...
    <div className="space-y-4">
      <div className="grid gap-4 md:grid-cols-2">
        <ToolTextArea
          ...
          rows={12}
        />
        <div className="rounded-xl border-3 border-black bg-white p-4 shadow-neo-sm">
          <h3 className="text-sm font-semibold text-slate-800">{LABELS.countsLabel}</h3>
          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            {statCards.map((card) => (
              <div key={card.label} className="rounded-lg border-3 border-black bg-slate-50 px-3 py-2">
