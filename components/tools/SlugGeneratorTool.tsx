  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <input type="text" value={input} onChange={e => setInput(e.target.value)} placeholder="My Blog Post Title Here" className="w-full rounded-lg border-3 border-black px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
      </div>
      {slug && (
        <div className="space-y-2">
          <label className="block text-sm font-medium text-slate-700">URL slug</label>
          <div className="flex items-center gap-2">
            <code className="flex-1 rounded-lg border-3 border-black bg-slate-50 px-3 py-2 text-sm font-mono">{slug}</code>
