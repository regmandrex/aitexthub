  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <textarea value={input} onChange={e => setInput(e.target.value)} rows={8} placeholder="Paste your SVG code here..." className="w-full rounded-lg border-3 border-black px-3 py-2 text-sm font-mono resize-none focus:outline-none focus:ring-2 focus:ring-blue-500" />
      </div>
