    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="flex gap-2">
          <input type="text" value={secret || generated} onChange={e => { setSecret(e.target.value); setGenerated(''); }} placeholder="JBSWY3DPEHPK3PXP" className="flex-1 rounded-lg border border-slate-200 px-3 py-2 text-sm font-mono uppercase focus:outline-none focus:ring-2 focus:ring-blue-500" />
          <button onClick={generateSecret} className="px-4 py-2 rounded-lg border border-slate-200 hover:bg-slate-50 text-slate-700 text-sm font-medium transition-colors whitespace-nowrap">Generate secret</button>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1.5 text-sm text-slate-500">
          <div className="w-4 h-4 rounded-full border-2 border-slate-300 relative overflow-hidden">
      ...
      {token && (
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={generate} className="px-4 py-2 rounded-lg border border-slate-200 hover:bg-slate-50 text-slate-700 text-sm font-medium transition-colors">Refresh</button>
          </div>
        </div>
      )}
    </div>
