  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {opts.map(([label, val, options], i) => (
          <div key={label}>
            ...
            <select value={val} onChange={e => setters[i](e.target.value)} className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
      ...
      <div>
        ...
        <div className="rounded-lg border border-slate-200 bg-slate-100 p-4 min-h-[120px]">
