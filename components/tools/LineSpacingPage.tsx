...
export default function LineSpacingPage({ modelName, modelSlug, faqItems, content }: Props) {
  ...
  const title = `${modelName} Line Spacing Tool`;
    ...
    <div className="relative min-h-screen bg-[#f7f9ff]">
      ...
      <div className="mx-auto w-full max-w-4xl px-4 py-10">
        <section className="space-y-3 text-center">
          ...
          <div className="space-y-2">
            <p className="max-w-2xl mx-auto text-sm text-slate-700 md:text-[15px]">
              Adjust line spacing to single, 1.5, double, or custom spacing for clean, professional formatting.
            </p>
          </div>
        </section>
          ...
          <section className="space-y-6 mt-10">
            <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 space-y-4">
              ...
              <ul className="list-disc list-inside space-y-1 text-slate-700">
                <li>Normalizes line breaks between paragraphs to your selected spacing.</li>
                <li>Preserves content while adjusting spacing for better readability.</li>
                <li>Supports single, 1.5, double, and custom line spacing options.</li>
              </ul>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 space-y-4">
              <h2 className="text-xl font-semibold text-slate-900">What it can / can&apos;t do</h2>
              <ul className="list-disc list-inside space-y-1 text-slate-700">
                <li>Can adjust spacing between paragraphs for better formatting.</li>
                <li>Can normalize inconsistent line breaks in text.</li>
                <li>Can&apos;t change font size or character spacing.</li>
        ...
        <div className="mt-10 space-y-3">
          <h2 className="text-2xl font-semibold text-slate-900">{modelName} Line Spacing Tool - Frequently Asked Questions</h2>
          <p className="text-slate-700">
            This FAQ covers common line spacing questions, how the tool works, and best practices for formatting text with proper spacing.
          </p>
        </div>
