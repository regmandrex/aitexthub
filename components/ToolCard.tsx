...
export default function ToolCard({ title, description, href, ctaLabel = 'Open tool' }: ToolCardProps) {
  return (
    <Link
      href={href}
      className="group block h-full rounded-xl border-3 border-black bg-white p-4 shadow-neo-sm transition-transform hover:-translate-y-0.5 hover:shadow-neo md:p-5"
    >
