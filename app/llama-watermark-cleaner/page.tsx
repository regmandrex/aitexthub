...
export const metadata = buildMeta({
  title: 'LLAMA Watermark Cleaner - Remove Hidden Characters from LLAMA AI Text',
  description:
    'Remove hidden characters and watermarks from LLAMA output. Strip zero-width/NBSP Unicode, fix spacing, and prepare clean text for Word, Docs, and CMS.',
...
export default function LLAMAWatermarkCleanerPage() {
  return (
    <div className="relative min-h-screen bg-[#f7f9ff]">
      <JsonLd
        data={webPageSchema({
          name: 'LLAMA Watermark Cleaner',
      ...
      <div className="mx-auto w-full max-w-4xl px-4 py-10">
        <section className="space-y-3 text-center">
          <h1 className="text-2xl font-semibold text-slate-900 md:text-3xl">LLAMA Watermark Cleaner</h1>
          <p className="max-w-2xl mx-auto text-sm text-slate-700 md:text-[15px]">
            Remove hidden characters and watermarks from LLAMA outputs. Keep paragraphs intact and prepare clean, editor-safe text for Word,
