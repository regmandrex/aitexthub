...
const toolSlug = 'grok-paragraph-rewriter';

function createWriteUp() {
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        <h2>Grok Paragraph Rewriter: Enhance Paragraph Structure and Flow</h2>
        <p>A Grok Paragraph Rewriter is a free online tool that rewrites full paragraphs from Grok output to improve flow, coherence, and readability. It helps you strengthen topic sentences, improve transitions, and create better structure so each paragraph supports your argument or narrative clearly.</p>
        ...
        <h2>How the Grok Paragraph Rewriter Works</h2>
        ...
        <h2>Who Should Use a Grok Paragraph Rewriter</h2>
        <p>Writers and students who want to improve paragraph flow and clarity without changing meaning can use it. Use the Grok Paragraph Rewriter when sections feel disconnected, when transitions are weak, or when a paragraph does not clearly support one main point.</p>

        <h2>How to Use the Grok Paragraph Rewriter</h2>
        ...
        <p>Review every rewritten paragraph to ensure it fits your outline and voice. Check that key facts and citations are preserved. Use the Grok Paragraph Rewriter as part of a full revision process—after drafting and before final proofreading.</p>
...
export default async function GrokParagraphRewriterPage() {
  const toolData = getToolBySlug(toolSlug);
    ...
    <>
      ...
      <ToolPageShell tool={{ ...toolData, title, shortDescription: description }} ui={<ChatGPTParagraphRewriterTool />} related={<RelatedTools currentSlug={toolData.slug} />}>
        ...
        <div className="mt-10 space-y-3">
          ...
          <p className="text-slate-700">Common questions about the Grok Paragraph Rewriter.</p>
        </div>
