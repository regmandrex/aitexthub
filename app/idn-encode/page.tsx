...
const description = tool?.shortDescription ?? 'Convert international domain names to ASCII Punycode.';
const title = tool?.title ?? 'IDN Encode';
...
export default function IdnEncodePage() {
  ...
  return (
    <>
      ...
      <ToolPageShell tool={toolData} ui={<IdnEncodeTool />} related={<RelatedTools currentSlug={toolData.slug} />}>
        {writeUp}
