  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <p>Shakespearean translator tools run in the browser. You enter text, click translate, and copy the result. For text cleanup and other tools, see the site.</p>
...
export default async function ShakespeareanTranslatorPage() {
  ...
  const pageFaqs: FaqItem[] = [
    ...
    { category: 'General', question: 'Where can I find more translator tools?', answer: 'See the site for more text and translator tools for different periods and styles.' },
  ];
