...
const description = tool?.shortDescription ?? 'Convert text into Base64 safely.';
const title = tool?.title ?? 'Base64 Encode';
...
export default function Base64EncodePage() {
  ...
  return (
    <>
      ...
      <ToolPageShell tool={toolData} ui={<Base64EncodeTool />} related={<RelatedTools currentSlug={toolData.slug} />}>
        {writeUp}
