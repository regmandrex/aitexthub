...
const faqIntro =
  'This FAQ explains how the AI Watermark Detector on AI Text Cleanup Tools analyzes text, what its signals mean, and how to interpret results responsibly. The tool is text-only, does not connect to any AI system, and does not claim certainty about authorship.';
...
const writeUp = (
  <section className="rounded-2xl border-3 border-black bg-white p-4 shadow-neo-sm md:p-6 mt-10">
    <div className="prose prose-slate max-w-none">
      ...
      <p>
        The AI Watermark Detector on AI Text Cleanup Tools is designed to help users understand the surface signals that can appear in AI-era text.
      ...
      <p>
        AI Text Cleanup Tools is a tool hub, not an AI provider. The AI Watermark Detector works only on text you provide and never connects to
      ...
      <p>
        The tool follows a clear, UI-driven workflow designed to match the patterns of other AI Text Cleanup Tools. You paste text, run a scan, and
      ...
      <p>
        The AI Watermark Detector on AI Text Cleanup Tools is a practical way to surface formatting artifacts and hidden characters that can disrupt
