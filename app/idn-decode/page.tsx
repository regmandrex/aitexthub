...
const description = tool?.shortDescription ?? 'Decode Punycode domains into readable Unicode.';
const title = tool?.title ?? 'IDN Decode';
...
export default function IdnDecodePage() {
  ...
  return (
    <>
      ...
      <ToolPageShell tool={toolData} ui={<IdnDecodeTool />} related={<RelatedTools currentSlug={toolData.slug} />}>
        {writeUp}
