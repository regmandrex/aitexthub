...
const pageFaqs: FaqItem[] = [
  ...
  { category: 'Best practices', question: 'Should I run the Amusement Park name generator multiple times?', answer: 'Yes. Running the Amusement Park name generator multiple times is the intended workflow when you want a large pool of Amusement Park name ideas. Paste each run into one document and remove duplicates if any appear. Then check availability on your game or story for each name you like. Having a shortlist saves time compared to checking one idea at a time. There is no daily or total limit on how many times you can run the generator.' },
  { category: 'Troubleshooting', question: 'Why is my first choice from the Amusement Park name generator taken?', answer: 'Popular theme park names are often already in use on Amusement Park and other platforms. The Amusement Park name generator does not check availability; it only suggests combinations. Always have a shortlist of five to ten options so you have backups. Run the generator again for more Amusement Park name ideas and check availability on your platform before committing. This is normal when using any name generator for creative projects.' },
  { category: 'Troubleshooting', question: 'Can I use the Amusement Park name generator offline?', answer: 'Yes. Once the page is loaded, the Amusement Park name generator runs entirely in your browser and does not require a network connection to generate names. You can generate character name ideas offline. Copying and pasting also works offline. You will need a connection only to open the page initially and to check availability on Amusement Park or another platform.' },
];
