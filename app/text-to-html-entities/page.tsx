...
const description = tool?.shortDescription ?? 'Encode text into HTML entities for safe markup.';
const title = tool?.title ?? 'Text to HTML Entities Converter';
...
export default function TextToHtmlEntitiesPage() {
  ...
  return (
    <>
      ...
      <ToolPageShell tool={toolData} ui={<TextToHtmlEntitiesTool />} related={<RelatedTools currentSlug={toolData.slug} />}>
        {writeUp}
