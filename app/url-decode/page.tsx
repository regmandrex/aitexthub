...
const description = tool?.shortDescription ?? 'Decode percent encoded URLs back to readable text.';
const title = tool?.title ?? 'URL Decode';
...
export default function UrlDecodePage() {
  ...
  return (
    <>
      ...
      <ToolPageShell tool={toolData} ui={<UrlDecodeTool />} related={<RelatedTools currentSlug={toolData.slug} />}>
        {writeUp}
