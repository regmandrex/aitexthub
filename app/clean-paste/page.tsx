...
const faqs: FaqItem[] = [
  ...
  {
    category: 'General',
    question: 'How does this clean paste site handle "clear space copy paste" problems?',
    answer: 'Clear space copy paste problems occur when pasted text has irregular spacing from non-breaking spaces (U+00A0) and zero-width space artifacts (U+200B) that look like normal spaces but behave differently. This clean paste site resolves all clear space copy paste issues automatically: every non-standard space character is found and normalized to a standard single space. After cleaning, your pasted text has completely consistent, standard spacing throughout — no more invisible space irregularities from copy-paste operations.',
  },
];
