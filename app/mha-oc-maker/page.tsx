...
const pageFaqs: FaqItem[] = [
  ...
  { category: 'Output', question: 'Does the MHA OC maker generate an image?', answer: 'Yes. It creates one full-body anime-style character reference image with the selected Quirk direction, costume, palette, role, and personality.' },
