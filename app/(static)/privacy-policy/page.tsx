    ...
    <div className="bg-white overflow-x-hidden">
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 md:py-16 space-y-10">
        ...
        <section>
          ...
          <div className="overflow-hidden rounded-xl border border-slate-200">
            <div className="grid grid-cols-3 border-b border-slate-200 bg-slate-50 text-xs font-semibold uppercase tracking-wider text-slate-600">
              ...
              <div className="border-l border-slate-200 px-4 py-2.5">Purpose</div>
              <div className="border-l border-slate-200 px-4 py-2.5">Duration</div>
            </div>
            {[
              ...
              <div key={cookie.name} className={`grid grid-cols-3 text-sm ${i < 2 ? 'border-b border-slate-200' : ''}`}>
                <div className="px-4 py-2.5 font-medium text-slate-900">{cookie.name}</div>
                <div className="border-l border-slate-200 px-4 py-2.5 text-slate-700">{cookie.purpose}</div>
                <div className="border-l border-slate-200 px-4 py-2.5 text-slate-700">{cookie.duration}</div>
              </div>
            ))}
          </div>
        ...
        <section>
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={service.name} className="flex items-start gap-3 rounded-lg border border-slate-200 bg-white p-3">
                <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-violet-100">
                  <svg className="h-3 w-3 text-violet-700" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
        ...
        <section>
          ...
          <div className="overflow-hidden rounded-xl border border-slate-200">
            <div className="grid grid-cols-2 border-b border-slate-200 bg-slate-50 text-xs font-semibold uppercase tracking-wider text-slate-600">
              <div className="px-4 py-2.5">Data Type</div>
              <div className="border-l border-slate-200 px-4 py-2.5">Retention</div>
            </div>
            {[
              ...
              <div key={row.type} className={`grid grid-cols-2 text-sm ${i < 5 ? 'border-b border-slate-200' : ''}`}>
                <div className="px-4 py-2.5 font-medium text-slate-900">{row.type}</div>
                <div className="border-l border-slate-200 px-4 py-2.5 text-slate-700">{row.retention}</div>
              </div>
            ))}
          </div>
