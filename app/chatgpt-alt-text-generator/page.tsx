...
const faqs: FaqItem[] = [
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'What is alt text?', answer: 'Alt text (alternative text) is descriptive text added to images in HTML. It helps screen readers describe images to visually impaired users and provides context when images fail to load. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'What is the ChatGPT Alt Text Generator?', answer: 'The ChatGPT Alt Text Generator is a free tool that creates descriptive, SEO-friendly alt text for images. It generates accurate descriptions that improve accessibility and search visibility. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Why is alt text important?', answer: 'Alt text improves accessibility for visually impaired users, helps search engines understand image content for SEO, and provides fallback text when images don\'t load. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Is the alt text generator free?', answer: 'Yes, this ChatGPT Alt Text Generator is completely free with no registration required. You can generate alt text without usage limits. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Is my image stored when using this tool?', answer: 'No. The generator processes image descriptions locally in your browser without storing or transmitting images. Your images remain private. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'How long should alt text be?', answer: 'Alt text should be concise—typically 5-15 words or 125 characters maximum. Be descriptive but brief, focusing on what the image shows and why it matters. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Do alt text descriptions affect SEO?', answer: 'Yes, alt text helps search engines understand image content, which can improve image search rankings and overall page SEO. It\'s an important ranking factor. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Should decorative images have alt text?', answer: 'Decorative images that don\'t convey information should use empty alt text (alt="") rather than descriptive text. This tells screen readers to skip them. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'What makes good alt text?', answer: 'Good alt text is specific, concise, and contextually relevant. It describes what the image shows and why it matters to the page content, without being redundant. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Should alt text include "image of" or "picture of"?', answer: 'No, avoid phrases like "image of" or "picture of." Screen readers already announce images, so start directly with the description: "Woman reading book" not "Image of woman reading book." That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'How do I add alt text to images?', answer: 'Add alt text in HTML using the alt attribute: <img src="image.jpg" alt="Your description">. Most CMS platforms provide alt text fields in image settings. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Can alt text include keywords for SEO?', answer: 'Yes, include relevant keywords naturally when they accurately describe the image. However, prioritize accurate description over keyword stuffing. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Should alt text match image filenames?', answer: 'Alt text should be more descriptive than filenames. Filenames like "IMG123.jpg" provide no context; alt text should describe what the image shows. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'What about images with text in them?', answer: 'If images contain important text, include that text in the alt description. This ensures the information is accessible to all users. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'How do I describe complex images?', answer: 'For complex images (charts, graphs, infographics), provide a brief summary in alt text and consider providing detailed descriptions elsewhere on the page. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Should product images have descriptive alt text?', answer: 'Yes, product images should include product names, key features, or relevant details. "Red leather handbag with gold hardware" is better than "Handbag." That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Can the generator help with different image types?', answer: 'Yes, the tool can generate alt text for various image types—photos, illustrations, charts, logos, and more. Adjust output based on image purpose. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'What about images used as links?', answer: 'When images function as links, alt text should describe the link destination, not just the image. "Contact us" is better than "Envelope icon" for a contact link. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'How do I test if alt text is effective?', answer: 'Use screen reader software to test how alt text sounds. Ensure descriptions are clear, concise, and provide necessary context without being redundant. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Should alt text be written in present tense?', answer: 'Alt text is typically written in present tense. "Woman reading book" is more natural than "Woman reads book" or "Woman read book." That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'What about images in social media?', answer: 'Social media platforms have their own alt text fields. Use similar principles—be descriptive, concise, and contextually relevant. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Can I use the same alt text for similar images?', answer: 'Similar images can have similar alt text, but ensure each description accurately represents its specific image. Generic descriptions may miss important details. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'How do I handle images with captions?', answer: 'If images have captions that fully describe them, alt text can be shorter or focus on details the caption doesn\'t cover. Avoid redundancy. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'What makes alt text accessible?', answer: 'Accessible alt text accurately describes image content in a way that helps users understand context and meaning, especially when images convey important information. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Should alt text include emotional context?', answer: 'When relevant, include emotional context. "Smiling family at beach" conveys more than "Family at beach." Context helps users understand image purpose. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'How do I describe images with people?', answer: 'Focus on what\'s relevant to the content. Avoid describing appearance unless relevant. "Businessperson presenting" is better than detailed physical descriptions. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Can the generator help with e-commerce product images?', answer: 'Yes, the tool can generate product-focused alt text that includes product names, colors, features, and other relevant details for e-commerce. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  ...
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'How do I ensure alt text is accurate?', answer: 'Review generated alt text against the actual image. Ensure descriptions accurately represent what the image shows and its purpose on the page. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Alt Text Generator FAQs', question: 'Should I update alt text when images change?', answer: 'Yes, update alt text when images are replaced or when image context changes. Keep descriptions current and accurate. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' }
];
...
const writeUp = (
  <section className="rounded-2xl border-3 border-black bg-white p-4 shadow-neo-sm md:p-6 mt-10">
    <div className="prose prose-slate max-w-none">
      ...
      <p>AI Text Cleanup Tools provides this alt text generator as a free resource for website owners, content creators, and developers. The tool processes image descriptions locally in your browser, ensuring your information remains private.</p>
      ...
      <p>Use screen reader software to test how alt text sounds. This helps ensure descriptions are clear and helpful.</p>
        ...
        <h2>How ChatGPT Alt Text Generator Fits Into AI Writing Workflows in 2026</h2>
        <p>As AI-assisted writing becomes routine in schools, publishing teams, and business workflows, the ChatGPT Alt Text Generator gives users a practical way to review text before they rely on it. Whether you are reviewing coursework, editing submissions, or checking professional drafts, understanding what the ChatGPT Alt Text Generator can and cannot tell you makes the review process clearer and more consistent.</p>
        <p>The sections below explain why tools like this exist, where they belong in a broader review process, and how to respond to the results without treating them as an automatic verdict. The goal is to help you use the ChatGPT Alt Text Generator with more confidence while still respecting policy requirements, context, and human judgment.</p>
        ...
        <p>The ChatGPT Alt Text Generator should support human review, not replace it or override an official process. It adds one signal that can help you decide which passages need closer reading, discussion, revision, or escalation under your own policy. For high-stakes decisions, use the approved tools, documentation standards, and review steps required by your institution or organization.</p>

        <h3>How the ChatGPT Alt Text Generator Fits Into Your Workflow</h3>
        <p>The ChatGPT Alt Text Generator works best as a screening step, not as the final word. For educators, that might mean running detection or analysis on drafts before grading, or using the tool to start conversations with students about AI use and citation. For editors and publishers, it can mean a quick check before sending work to external verification services or to inform author discussions. For professionals and businesses, it can support internal reviews when authenticity and human authorship matter.</p>
        <p>If other people are affected by the result, explain how you use the ChatGPT Alt Text Generator and what happens when a page or passage needs a closer look. A consistent, transparent process makes the tool more useful and reduces confusion around borderline results.</p>

        <h2>Tips for Consistent Use of the ChatGPT Alt Text Generator</h2>
        <p>For better results with the ChatGPT Alt Text Generator, use full paragraphs or complete sections, avoid tiny fragments, and run checks in a repeatable way so different drafts can be compared fairly. No automated tool is perfect, so read the output as a signal to investigate rather than a standalone conclusion.</p>

        <h3>Input Quality and Length</h3>
        <p>Most AI-content review tools behave more reliably when the input is long enough and written as a coherent passage. If the ChatGPT Alt Text Generator recommends a minimum word count or suggests using full paragraphs, follow that guidance. Very short snippets and disconnected fragments can produce unstable results. When possible, submit text that reflects how the content would actually be used or assessed.</p>
