...
const title = 'Log in — GPTCleanup Tools';
const description = 'Log in to your GPTCleanup Tools account to access Pro features, manage your subscription, and use higher input limits.';

export async function generateMetadata(): Promise<Metadata> {
  return buildMeta({ title, description, urlPath: '/login' });
}
    ...
    <div className="min-h-[calc(100vh-200px)] bg-slate-50">
      <div className="mx-auto flex max-w-md flex-col items-center px-4 py-12 md:py-20">
        ...
        <p className="mt-4 text-center text-xs text-slate-500">
          Sign-in launches alongside Pro. Bookmark this page — you&apos;ll be the first to know.
        </p>
      </div>
    </div>
  );
