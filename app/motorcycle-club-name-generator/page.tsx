  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <h2>Introduction</h2>
        <p>
          This guide explains how to use a Motorcycle Club name generator to create club and biker names for Motorcycle Club and other fiction and creative projects. The tool runs in your browser and produces unique, memorable name ideas at the click of a button. It is designed for players who want Motorcycle Club name ideas quickly without sign-up or download. The generator does not store data and runs entirely in your browser. You get 1–24 names per run and can run it as often as you like. Always check your game or story for availability before committing to a name.
        </p>
        <p>
          People search for Motorcycle Club name ideas and character name generators when setting up a new profile, an esports handle, or a stream name. This Motorcycle Club name generator serves that intent with one free, browser-based tool. Whether you need a single standout character name or a shortlist of options, the generator gives you a pool of ideas. Names must be unique on each service, so verifying availability on Motorcycle Club or your chosen platform is an essential step after generating ideas.
        </p>

        <h2>What Is a Motorcycle Club Name Generator?</h2>
        <p>
          A Motorcycle Club name generator is an online tool that creates club and biker names suitable for Motorcycle Club and other fiction and creative projects. You get unique name ideas at the click of a button. The generator combines curated biker-style words and elements at random so each run produces new combinations. The output is for inspiration only; you must check your platform for availability. This free Motorcycle Club name generator runs in your browser with no sign-up and does not send generated names to any server.
        </p>
        <p>
          The output is plain text, one name per line. You can copy the full list and paste it into a notes app, then check your game or story for availability and pick one. Many users run the Motorcycle Club name generator multiple times to build a shortlist before deciding. Because names are created locally, your choices stay private and nothing is stored on our servers.
        </p>
        <p>
...
const pageFaqs: FaqItem[] = [
  ...
  { category: 'Best practices', question: 'Should I run the Motorcycle Club name generator multiple times?', answer: 'Yes. Running the Motorcycle Club name generator multiple times is the intended workflow when you want a large pool of Motorcycle Club name ideas. Paste each run into one document and remove duplicates if any appear. Then check availability on your game or story for each name you like. Having a shortlist saves time compared to checking one idea at a time. There is no daily or total limit on how many times you can run the generator.' },
  { category: 'Troubleshooting', question: 'Why is my first choice from the Motorcycle Club name generator taken?', answer: 'Popular club and biker names are often already in use on Motorcycle Club and other platforms. The Motorcycle Club name generator does not check availability; it only suggests combinations. Always have a shortlist of five to ten options so you have backups. Run the generator again for more Motorcycle Club name ideas and check availability on your platform before committing. This is normal when using any name generator for fiction and creative projects.' },
  { category: 'Troubleshooting', question: 'Can I use the Motorcycle Club name generator offline?', answer: 'Yes. Once the page is loaded, the Motorcycle Club name generator runs entirely in your browser and does not require a network connection to generate names. You can generate character name ideas offline. Copying and pasting also works offline. You will need a connection only to open the page initially and to check availability on Motorcycle Club or another platform.' },
];
