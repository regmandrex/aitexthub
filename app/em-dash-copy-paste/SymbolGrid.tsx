...
export const symbols = [
  { name: 'Em Dash', char: 'â€”', unicode: 'U+2014', html: '&mdash;', description: 'The longest dash. Used to indicate a pause, interruption, or parenthetical remark in prose.', example: 'She opened the doorâ€”and froze.' },
  { name: 'En Dash', char: 'â€“', unicode: 'U+2013', html: '&ndash;', description: 'Half the width of an em dash. Used for ranges, scores, and compound adjectives.', example: 'Pages 10â€“25, New Yorkâ€“London flight' },
  { name: 'Horizontal Bar', char: 'â€•', unicode: 'U+2015', html: '&#8213;', description: 'Longer than an em dash. Used in dialogue attribution in some languages.', example: 'Used in Greek and some European typography' },
  ...
  { name: 'Non-Breaking Hyphen', char: 'â€‘', unicode: 'U+2011', html: '&#8209;', description: 'Hyphen that prevents a line break at its position.', example: 'Phone numbers, fixed compounds' },
  { name: 'Figure Dash', char: 'â€’', unicode: 'U+2012', html: '&#8210;', description: 'Same width as a digit. Used in phone numbers and tables.', example: '555â€’1234' },
  { name: 'Ellipsis', char: 'â€¦', unicode: 'U+2026', html: '&hellip;', description: 'Single-character ellipsis. Better than three separate periods for typography.', example: 'She waitedâ€¦ and waited.' },
  { name: 'Bullet Point', char: 'â€¢', unicode: 'U+2022', html: '&bull;', description: 'Standard bullet point for lists.', example: 'â€¢ Item one â€¢ Item two' },
  { name: 'Middle Dot', char: 'Â·', unicode: 'U+00B7', html: '&middot;', description: 'Small centered dot used as a separator in lists and text.', example: 'Paris Â· London Â· New York' },
...
export function SymbolGrid() {
  return (
    <section className="mt-6 w-full rounded-xl border border-slate-200 bg-white p-4 shadow-sm md:rounded-2xl md:p-6">
      <h2 className="text-base font-semibold text-slate-800 mb-4">Click to Copy â€” Dashes, Dots & Symbols</h2>
            ...
            <div className="flex items-start justify-between gap-2">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-mono">{s.unicode} Â· {s.html}</p>
                </div>
              </div>
