  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <h2>Understanding Perplexity LinkedIn Rewriter and AI Content in 2024</h2>
        <p>As AI-generated text becomes more common across education, publishing, and business, tools like the Perplexity LinkedIn Rewriter play an important role in helping users understand and work with that content. Whether you are an educator checking assignments, an editor screening submissions, or a professional verifying authenticity, having a clear picture of how the Perplexity LinkedIn Rewriter works and when to use it supports better decisions and more transparent communication.</p>
        <p>This section adds context on why these tools exist, how they fit into broader workflows, and how to interpret and act on their results. The goal is to give you enough background to use the Perplexity LinkedIn Rewriter confidently while respecting its limits and combining it with your own judgment and any institutional or organizational policies that apply.</p>
...
export default async function ClaudeLinkedInRewriterPage() {
  ...
  const pageFaqs: FaqItem[] = [
    ...
    { category: 'Privacy', question: 'Is my text stored when I use the Perplexity LinkedIn Rewriter?', answer: 'No. Processing runs in your browser; your text is not sent to our servers or stored. The Perplexity LinkedIn Rewriter keeps your content local, so you can rewrite LinkedIn posts and profile text without sending them elsewhere. This helps ensure you use the tool effectively and supports informed decisions about content quality and authenticity.' },
    ...
    { category: 'Technical', question: 'Does the Perplexity LinkedIn Rewriter work on mobile?', answer: 'Yes. The tool runs in the browser and works on phones and tablets. You can rewrite LinkedIn content on the go. No app download is required; open the Perplexity LinkedIn Rewriter page on your device and paste your text as you would on desktop. This helps ensure you use the tool effectively and supports informed decisions about content quality and authenticity.' },
    ...
    { category: 'Privacy', question: 'Do you keep a copy of my text?', answer: 'No. Processing is local in your browser. We do not store or log your content. When you use this free Perplexity LinkedIn Rewriter, your text never leaves your device. That is important for draft posts and professional content. This helps ensure you use the tool effectively and supports informed decisions about content quality and authenticity.' },
    { category: 'General', question: 'How often can I use the Perplexity LinkedIn Rewriter?', answer: 'The tool is free to use as often as you need. There are no per-day or per-user limits. Use it for every post or profile section you want to adapt for LinkedIn. Combine it with your own voice and branding for the best results. This helps ensure you use the tool effectively and supports informed decisions about content quality and authenticity.' },
    ...
    { category: 'Usage', question: 'Should I run the Perplexity LinkedIn Rewriter before or after drafting?', answer: 'You can use it after you have a draft—whether from Perplexity or your own writing. Paste the draft, run the rewriter, and review the output. Then add your personal touch—achievements, links, hashtags, stories—before posting. The rewriter adapts structure and tone; you add authenticity. This helps ensure you use the tool effectively and supports informed decisions about content quality and authenticity.' },
    ...
    { category: 'Limits', question: 'What are the limitations of the Perplexity LinkedIn Rewriter?', answer: 'Automated rewriting can sometimes alter nuance. Always verify that the output is accurate and appropriate for your brand and audience. Use the Perplexity LinkedIn Rewriter as a starting point; the final post or profile should reflect your voice and goals. Combine it with your own stories and expertise. This helps ensure you use the tool effectively and supports informed decisions about content quality and authenticity.' },
