...
const faqs: FaqItem[] = [
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'What is the ChatGPT Passive Voice Fixer?', answer: 'The ChatGPT Passive Voice Fixer is a free tool that identifies passive voice constructions in your writing and suggests active voice alternatives. It helps you create more direct, engaging prose. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'What is passive voice?', answer: 'Passive voice occurs when the subject receives the action rather than performing it. "The ball was thrown by John" is passive; "John threw the ball" is active. Passive emphasizes the action or recipient; active emphasizes the doer. That keeps the result useful as a practical pre-check instead of a final judgment.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Is the passive voice fixer free?', answer: 'Yes, this ChatGPT Passive Voice Fixer on AI Text Cleanup Tools is completely free with no registration required. You can fix passive voice without usage limits or subscription fees. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Is my text stored when using this tool?', answer: 'No. The passive voice fixer processes text locally in your browser without storing or transmitting content. Your text remains private throughout the process. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  ...
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'When should I use passive voice?', answer: 'Use passive when: the doer is unknown ("The window was broken"), the doer is less important than the action ("Mistakes were made"), or in scientific writing emphasizing processes over researchers. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Why is active voice generally preferred?', answer: 'Active voice is typically more direct, concise, and engaging. It clearly identifies who does what, creating stronger prose. Readers process active constructions more easily. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'How do I identify passive voice?', answer: 'Passive voice typically uses a form of "to be" (was, were, is, are) plus a past participle. The subject receives rather than performs the action. "The report was written" vs. "She wrote the report." That keeps the result useful as a practical pre-check instead of a final judgment.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Does the tool convert all passive to active?', answer: 'The tool identifies passive constructions and suggests active alternatives. You decide which conversions improve your writing—some passive uses may be intentional and appropriate. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'How much passive voice is too much?', answer: 'There is no strict percentage, but excessive passive voice makes writing feel indirect and bureaucratic. Most style guides recommend active voice as the default, with passive reserved for specific purposes. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Does passive voice affect readability?', answer: 'Yes, excessive passive voice reduces readability. Active voice is more direct and easier to process. Passive voice often requires more words and creates less engaging prose. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Can the tool help with AI-generated content?', answer: 'Yes, AI content sometimes overuses passive voice. The fixer identifies these instances for conversion, making AI-assisted writing more direct and engaging. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'What about scientific writing?', answer: 'Scientific writing traditionally used passive voice ("The experiment was conducted") but many journals now prefer active voice ("We conducted the experiment"). Check your target publication\'s style. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Does passive voice affect word count?', answer: 'Passive constructions are often longer than active equivalents. Converting to active voice can reduce word count while improving clarity. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  ...
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Does the tool work with non-English text?', answer: 'The tool is optimized for English. Passive voice constructions differ across languages. English analysis will be most accurate. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'How does passive voice affect tone?', answer: 'Passive voice creates more formal, impersonal, or distant tone. It can sound bureaucratic or evasive. Active voice feels more direct, confident, and engaging. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Should business writing avoid passive voice?', answer: 'Business writing benefits from active voice for clarity and directness. Passive voice can obscure responsibility ("Mistakes were made" vs. "We made mistakes"). That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'What is the "by zombie" test?', answer: 'If you can add "by zombies" after the verb and it makes grammatical sense, the sentence is probably passive. "The report was written [by zombies]" works; "She wrote the report [by zombies]" does not. That keeps the result useful as a practical pre-check instead of a final judgment.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Does passive voice always include "by"?', answer: 'No, "by" phrases are optional. "The report was written" is passive even without "by someone." The passive construction is about the verb form and subject relationship. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Can passive voice be more clear than active?', answer: 'Sometimes. When the actor is unknown or irrelevant, passive can be clearer. "The building was constructed in 1920" may work better than awkwardly inserting unknown builders. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'How do I convert passive to active?', answer: 'Identify the true actor (often in "by" phrase or implied), make them the subject, and use active verb form. "The cake was eaten by children" becomes "Children ate the cake." That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Does fiction allow more passive voice?', answer: 'Fiction writing has stylistic flexibility. Passive voice can create specific effects—mystery, distance, formal speech. Use intentionally for effect, not by default. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'What percentage of passive voice is normal?', answer: 'Strong writing typically has 5-15% passive voice. Higher percentages suggest overuse. The right amount depends on context and purpose. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Can I review suggestions before applying?', answer: 'Yes, the tool shows passive instances and suggests alternatives. You review and decide which changes to make. Not all passive voice needs changing. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Does the tool explain why constructions are passive?', answer: 'The tool identifies passive voice and provides active alternatives. Understanding the pattern helps you recognize passive voice in future writing. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'How does passive voice affect persuasion?', answer: 'Active voice is generally more persuasive—clearer, more confident, more engaging. Passive can seem evasive or weak. Persuasive writing typically prefers active voice. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Passive Voice Fixer FAQs', question: 'Can the tool help me learn to avoid passive voice?', answer: 'Yes, seeing patterns in your writing helps you recognize passive constructions. Over time, you will naturally write more actively. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' }
];
...
const writeUp = (
  <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
    <div className="prose prose-slate max-w-none">
      ...
      <p>AI Text Cleanup Tools provides this passive voice fixer as a free resource for writers seeking clearer, more direct communication. The tool processes text locally in your browser, ensuring your content remains private throughout the analysis.</p>
      ...
      <p>Use tools like this fixer during editing. First drafts may have unintentional passive voice that revision can address.</p>
        ...
        <h2>How ChatGPT Passive Voice Fixer Fits Into AI Writing Workflows in 2026</h2>
        <p>As AI-assisted writing becomes routine in schools, publishing teams, and business workflows, the ChatGPT Passive Voice Fixer gives users a practical way to review text before they rely on it. Whether you are reviewing coursework, editing submissions, or checking professional drafts, understanding what the ChatGPT Passive Voice Fixer can and cannot tell you makes the review process clearer and more consistent.</p>
        <p>The sections below explain why tools like this exist, where they belong in a broader review process, and how to respond to the results without treating them as an automatic verdict. The goal is to help you use the ChatGPT Passive Voice Fixer with more confidence while still respecting policy requirements, context, and human judgment.</p>
        ...
        <p>The ChatGPT Passive Voice Fixer should support human review, not replace it or override an official process. It adds one signal that can help you decide which passages need closer reading, discussion, revision, or escalation under your own policy. For high-stakes decisions, use the approved tools, documentation standards, and review steps required by your institution or organization.</p>

        <h3>How the ChatGPT Passive Voice Fixer Fits Into Your Workflow</h3>
        <p>The ChatGPT Passive Voice Fixer works best as a screening step, not as the final word. For educators, that might mean running detection or analysis on drafts before grading, or using the tool to start conversations with students about AI use and citation. For editors and publishers, it can mean a quick check before sending work to external verification services or to inform author discussions. For professionals and businesses, it can support internal reviews when authenticity and human authorship matter.</p>
        <p>If other people are affected by the result, explain how you use the ChatGPT Passive Voice Fixer and what happens when a page or passage needs a closer look. A consistent, transparent process makes the tool more useful and reduces confusion around borderline results.</p>

        <h2>Tips for Consistent Use of the ChatGPT Passive Voice Fixer</h2>
        <p>For better results with the ChatGPT Passive Voice Fixer, use full paragraphs or complete sections, avoid tiny fragments, and run checks in a repeatable way so different drafts can be compared fairly. No automated tool is perfect, so read the output as a signal to investigate rather than a standalone conclusion.</p>

        <h3>Input Quality and Length</h3>
        <p>Most AI-content review tools behave more reliably when the input is long enough and written as a coherent passage. If the ChatGPT Passive Voice Fixer recommends a minimum word count or suggests using full paragraphs, follow that guidance. Very short snippets and disconnected fragments can produce unstable results. When possible, submit text that reflects how the content would actually be used or assessed.</p>

        <h3>Next Steps After You Get Results</h3>
        <p>Results from the ChatGPT Passive Voice Fixer are indicators, not proof. Do not use a single score or label by itself to accuse, punish, or make a final decision. Use the result to decide what to reread, what to ask the author, or whether another approved check is needed. Document how you use the tool and what policies you follow so that your process is clear and fair.</p>
