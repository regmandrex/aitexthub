  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <p>Writers building Transformers-inspired or robot-themed worlds often need many character and faction names. Run the generator multiple times with title-style names on or off to build a roster. Keep a naming document so you do not reuse the same name for two characters and so faction names stay consistent. For mixed-genre projects you can pair this tool with other naming tools for different cultures or creature names; when you paste names from the web into a manuscript or spreadsheet, a space remover or strip-HTML step can keep formatting clean.</p>
...
const pageFaqs: FaqItem[] = [
  ...
  { category: 'General', question: 'What other name generators do you have?', answer: 'We have name generators for Naruto, Fallout, Elden Ring, anime, god and goddess, ancient Greek, species, tribe, island, and others. See our homepage for the full list.' },
