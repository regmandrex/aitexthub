  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <h2>Choosing and Using Silly Names</h2>
        <p>Once you have a shortlist from the silly name generator, pick the name that fits your game or context. The generator aims for family-friendly silly names; review results for your audience. You can tweak a generated name (e.g. change one word) to make it unique. For other fun styles try our drag queen or bracket name generator.</p>
        <p>Teachers and hosts often run the generator once per participant so everyone gets a random silly name for an icebreaker or party game. The tool is free and runs in your browser with no sign-up.</p>
        <h2>Batch Generation and Building a Shortlist</h2>
        <p>Run the silly name generator several times with 12 or 24 names per run. Copy each batch into a single document and skim for names that fit your game or event. The generator has no daily limit. Paste all results in one place and remove duplicates if needed.</p>
        <p>For nicknames or usernames, pick one you like and use it as-is or tweak it. For other naming styles try our drag queen or anime names generator; see our homepage for the full list.</p>
        <h2>Formatting and Pasting Generated Names</h2>
        <p>The silly name generator outputs one name per line in plain text. When you paste into a notes app or document, the formatting is preserved. If you see extra spaces or line breaks after pasting from the web, run the text through a space remover or strip-HTML tool. Our site has both; see the homepage for links.</p>
        <h2>Tips for Funny and Hilarious Names</h2>
        <p>Short, punchy silly names often work best for games and nicknames. The silly name generator gives you combinations like &quot;Sir Pickle&quot; or &quot;Captain Waffle&quot;; you can use one as-is or mix and match. Run the generator often and keep a list of favourites. The free silly name generator (hilarious name generator) requires no account and does not store or send your data.</p>
        <p>Names are created in your browser only. For other naming tools see our homepage. Use the Copy button to grab all names at once and paste them into your notes.</p>
        <h2>Why Use a Silly Name Generator?</h2>
        <p>Coming up with funny names for games, icebreakers, or nicknames can be time-consuming. This silly name generator (or hilarious name generator) produces silly and hilarious name ideas in seconds. Run it as often as you like and copy the results into your notes. The tool is free and runs in your browser with no sign-up. For other fun naming styles try our drag queen or bracket name generator; see our homepage for the full list.</p>
        <p>You get up to 24 names per run with no daily limit. Names are created locally and are not sent to our servers. The generator aims for family-friendly silly names; review results for your context.</p>
        <p>Use the Copy button to copy all names at once. Paste into your notes and pick the name that fits your game, nickname, or event. For icebreakers run the generator once per person so everyone gets a random silly name. No download or account is required. You can run the silly name generator in private or incognito mode; names are created locally.</p>
        <h2>Summary</h2>
        ...
        <p>The free silly name generator (hilarious name generator) requires no account and does not store or send your data. Names are created in your browser only. Run it in batches to build a shortlist for games or icebreakers. No download is required and the tool works on all devices. Bookmark the page for quick access when you need funny names.</p>
        <p>Each run produces up to 24 names with no daily limit. The generator aims for family-friendly silly names. Combine with our drag queen or bracket name generator for other fun naming styles. See our homepage for the full list. There is no account, no download, and no daily cap. Use the Copy button to grab all names at once. Bookmark the page for quick access when you need funny or hilarious names for games, nicknames, or icebreakers.</p>
        <p>Names are created in your browser and are not sent to our servers. Run the silly name generator as often as you like to build a shortlist. For other fun or character names see our homepage for the full list of naming and text tools. No sign-up or download is required. The generator aims for family-friendly silly names. You get up to 24 names per run with no daily limit. Bookmark the page for quick access. The tool is free. Use it for games, nicknames, icebreakers, or party games. See our homepage for drag queen, anime, and bracket name generators. Paste results into your notes and pick the funny name that fits your game or event. There is no daily cap. The silly name generator runs locally and requires no account. Use the Copy button to grab all names at once. You can run the generator as often as you like with no limit. The tool works on desktop, tablet, and phone. For more options run the generator again. No account or download is required. Open the page and click generate to get names. See our homepage for more naming tools.</p>
      </div>
    </section>
  );
}
...
const pageFaqs: FaqItem[] = [
  ...
  { category: 'Privacy', question: 'Can I use it in private or incognito mode?', answer: 'Yes. The silly name generator runs in your browser and works in private or incognito windows. Names are created locally and are not sent to our servers. No account or login is required.' },
];
