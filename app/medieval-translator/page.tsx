  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <p>Using the medieval translator is straightforward. Open the tool, paste or type your modern English into the input area, and click the translate or convert button. The result appears in the output box; you can copy it into your document, script, or assignment. If your source text was copied from a webpage or email, strip any HTML and normalize spaces first so the input is clean—many writers use a dedicated space remover and HTML stripper for that step. For long texts, work in sections so you can review and adjust each part before combining.</p>
        ...
        <p>When you copy text from a webpage or document into the medieval translator, cleaning it first improves the result. Paste into a strip-HTML tool to remove markup, then use a space remover or similar utility to normalize spaces and line breaks. Once the text is plain and tidy, paste it into the medieval translator. That workflow keeps the input clean and the output easier to edit. After you translate to medieval, you may paste the result into a script, essay, or social post. If you combine it with other content from the web, run that content through the same cleanup steps so the final document is consistent. Many writers keep a bookmark for strip-HTML and space remover alongside the medieval translator for this reason.</p>

        <h2>Preparing Your Text Before You Translate</h2>
        <p>If you paste text from a webpage, email, or document, it may contain hidden formatting, extra spaces, or HTML. Cleaning that text first improves the result. Remove HTML markup with a strip-HTML utility and normalize spaces and line breaks with a space remover or similar tool. Once the input is plain text, run it through the medieval translator. The same cleanup step is useful after translating if you combine the output with other pasted content later.</p>
        ...
        <p>To translate to medieval with this tool, start by opening the page and locating the input box. Type or paste your modern English. If the text was copied from a webpage or a formatted document, clean it first: remove HTML markup and normalize spaces and line breaks so the input is plain text. That step reduces odd formatting in the output. Click the translate or convert button and wait for the result. Copy the medieval-style text into your document, script, or assignment. Read through and edit for clarity, tone, and consistency. For long pieces, work in sections—translate each section, edit it, then combine and smooth the transitions.</p>
        ...
        <p>If you paste text from a webpage, email, or document, it may contain hidden formatting, extra spaces, or HTML. Cleaning that text first improves the result. Remove HTML markup with a strip-HTML utility and normalize spaces and line breaks with a space remover or similar tool. Once the input is plain text, run it through the medieval translator. After translating, if you combine the output with other pasted content, run that content through the same cleanup steps so the final document is consistent. A simple workflow is: paste into strip-HTML, then space remover, then medieval translator; copy the result and edit as needed.</p>
        ...
        <p>Use a medieval translator when you need to translate to medieval or Middle English style for creative writing, education, role-play, or themed events. The tool is free, runs in the browser, and does not require sign-up. Clean pasted text before you translate so the input is plain and tidy. Treat the output as stylistic and approximate; edit for your audience and project. For formal or legal documents, use standard modern English. For other period or stylistic needs—Middle English, Old English, Shakespearean, fancy English, or English to Navajo—separate tools exist. Choose the one that matches your period and goal.</p>

        <h2>Related Period and Language Tools</h2>
        <p>If you need a different period or style, use our similar translator pages. The <Link href="/middle-english-translator">Middle English translator</Link> (Middle English converter) focuses on Chaucer-era language; the <Link href="/old-english-translator">Old English translator</Link> handles Anglo-Saxon (translate to Anglo Saxon); the <Link href="/shakespearean-translator">Shakespearean translator</Link> produces Early Modern “thee and thou” style. We also offer a <Link href="/navajo-translator">Navajo translator</Link> for English to Navajo and a <Link href="/fancy-english-translator">fancy English translator</Link> for decorative wording. For text cleanup and the full tool list, see the <Link href="/">homepage</Link>.</p>
        ...
        <p>Before you publish or submit text that used the medieval translator, check that the output is appropriate for your audience, that you cleaned pasted input if it came from the web, and that you edited the result for readability and consistency. Use the medieval translator for creative and educational purposes only; for formal or legal documents, use standard modern English. For other period or stylistic text—Middle English, Old English, Shakespearean, fancy English, or English to Navajo—choose the tool that matches your period. A quick workflow is: clean input (strip HTML, normalize spaces), translate to medieval, copy, edit, and integrate with your project.</p>
        <p>Bookmark this medieval translator page for quick access when you need to translate to medieval or Middle English style. The tool works on desktop and mobile with no install. For a full set of text and period tools, visit the main tool list from any device. Students, writers, and educators use it regularly for drafts, demos, and classroom discussion.</p>

        <h2>Conclusion</h2>
        <p>A medieval translator helps you translate to medieval or Middle English style for creative writing, education, role-play, or themed content. This free tool runs in your browser and does not require sign-up. Use the output as a starting point and edit for your audience and project. Treat the result as stylistic and approximate; pair it with primary texts and reference materials when you need deeper accuracy. For similar period and language tools—<Link href="/middle-english-translator">Middle English translator</Link>, <Link href="/old-english-translator">Old English translator</Link> (translate to Anglo Saxon), <Link href="/shakespearean-translator">Shakespearean translator</Link>, <Link href="/fancy-english-translator">fancy English translator</Link>, <Link href="/navajo-translator">Navajo translator</Link> (English to Navajo)—and for text cleanup, see the <Link href="/">homepage</Link>. You can use the medieval translator on any device with a modern browser.</p>
      </div>
    </section>
  );
}
...
export default async function MedievalTranslatorPage() {
  ...
  const pageFaqs: FaqItem[] = [
    ...
    { category: 'Technical', question: 'Is medieval the same as Middle English?', answer: 'In common use, medieval translator and Middle English translator often target the same period (Chaucer-era). Our Middle English translator page offers a dedicated Middle English converter; the medieval translator on this page gives a general medieval or Middle English style. Use either for literature courses, historical fiction, or period projects.' },
    ...
    { category: 'Use cases', question: 'Can I translate from medieval to modern English?', answer: 'This tool focuses on converting modern English into medieval or Middle English style. Some other tools offer reverse conversion from medieval to modern. For cleaning and formatting text before or after you translate, use a space remover or strip-HTML utility so your document stays consistent.' },
    ...
    { category: 'Limits', question: 'Is there a character limit?', answer: 'Browser-based medieval translators typically handle normal paragraph and page lengths. For very long texts, process in sections so you can review and edit each part before combining. If the text was pasted from the web, clean it with a space remover and strip-HTML tool first so the input is plain and consistent.' },
    ...
    { category: 'General', question: 'Where can I find a Middle English converter?', answer: 'Our Middle English translator page offers a dedicated Middle English converter. The medieval translator on this page also targets medieval and Middle English style. For a more Chaucer-focused Middle English converter, use the Middle English translator; for a general medieval flavor, use this page. Both are linked from our homepage alongside other period tools.' },
    ...
    { category: 'General', question: 'Can I translate long paragraphs?', answer: 'Yes. You can translate long paragraphs or full pages through the medieval translator. For long text, process in sections so you can review and edit each part; then combine and smooth the transitions. If the text was pasted from the web, clean it with a space remover and strip-HTML tool first.' },
    ...
    { category: 'Use cases', question: 'Medieval translator for role-play?', answer: 'Yes. Use the medieval translator for dialogue, signs, scrolls, or descriptions in medieval-themed LARP, tabletop games, or role-play. Keep phrases short so players can read them quickly. Pair it with primary texts or reference materials if you want deeper period accuracy; use a strip-HTML and space-remover tool for cleaning pasted text.' },
    { category: 'General', question: 'Where can I find more translator tools?', answer: 'Our homepage lists similar period and language tools: Middle English translator, Old English translator (translate to Anglo Saxon), Shakespearean translator, Navajo translator (English to Navajo), and fancy English translator. Each targets a different era or style—pick the one that matches your project.' },
  ];
