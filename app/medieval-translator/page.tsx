...
export default async function MedievalTranslatorPage() {
  ...
  const pageFaqs: FaqItem[] = [
    ...
    { category: 'General', question: 'Do I need to install the medieval translator?', answer: 'No. The medieval translator runs entirely in your browser, so there is no download or install. Open the page, paste your text, and translate to medieval style. The same applies on mobile: no app install is required.' },
