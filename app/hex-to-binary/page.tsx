...
const description = tool?.shortDescription ?? 'Convert hex strings to binary with formatting options.';
const title = tool?.title ?? 'Hex to Binary Converter';
...
export default function HexToBinaryPage() {
  ...
  return (
    <>
      ...
      <ToolPageShell tool={toolData} ui={<HexToBinaryTool />} related={<RelatedTools currentSlug={toolData.slug} />}>
        {writeUp}
