  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <p>Looking for the other direction? Use our <a href="/navajo-to-english-translator">Navajo to English translator</a> to convert Diné bizaad text into English for reading and study.</p>
...
export default async function NavajoTranslatorPage() {
  ...
  const pageFaqs: FaqItem[] = [
    ...
    { category: 'Use cases', question: 'Can I translate from Navajo to English?', answer: 'Yes. Use our Navajo to English translator at /navajo-to-english-translator, which takes Navajo (Dine bizaad) input and produces English. This page handles the opposite direction, converting English into Navajo. For cleaning and formatting text before or after you translate, use plain text so your document stays consistent.' },
