  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <p>Looking for the other direction? Use our <a href="/navajo-english-translator">Navajo to English translator</a> to convert Diné bizaad text into English for reading and study.</p>
