  ...
  return (
    <section className="rounded-2xl border-3 border-black bg-white p-4 shadow-neo-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <p>Looking for the other direction? Use our <Link href="/navajo-english-translator">Navajo to English translator</Link> to convert Diné bizaad text into English for reading and study.</p>
        ...
        <p>We also offer period and stylistic English translators; each fits a different use case. See the site for more tools and text utilities for cleaning pasted content.</p>
...
export default async function NavajoTranslatorPage() {
  ...
  const pageFaqs: FaqItem[] = [
    ...
    { category: 'Use cases', question: 'Can I translate from Navajo to English?', answer: 'Yes. Use our Navajo to English translator at /navajo-english-translator, which takes Navajo (Dine bizaad) input and produces English. This page handles the opposite direction, converting English into Navajo. For cleaning and formatting text before or after you translate, use plain text so your document stays consistent.' },
    { category: 'General', question: 'Navajo translator vs other language tools?', answer: 'See the site for more period and language tools; the Navajo translator is for English to Navajo (Diné bizaad) support.' },
    ...
    { category: 'Compatibility', question: 'Does the Navajo translator work on mobile?', answer: 'Yes. The Navajo translator runs in your browser on phones and tablets with no install or download required. You can paste text, get English to Navajo support, and copy the result into any app.' },
    { category: 'General', question: 'Where can I find an English to Navajo tool?', answer: 'This page is our English to Navajo translator. For period English style—Middle English, Old English (translate to Anglo Saxon), Shakespearean, or medieval—see our other translator pages. See the site for more period and language tools.' },
    ...
    { category: 'General', question: 'Do I need to install the Navajo translator?', answer: 'No. The Navajo translator runs entirely in your browser, so there is no download or install. Open the page, paste your English text, and get English to Navajo support. The same applies on mobile: no app install is required.' },
    ...
    { category: 'General', question: 'Where can I find more translator tools?', answer: 'See the site for more period and language tools; pick the one that matches your project.' },
  ];
