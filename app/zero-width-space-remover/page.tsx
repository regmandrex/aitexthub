...
export default function ZeroWidthSpaceRemoverPage() {
  ...
  return (
    <>
      ...
      <ToolPageShell tool={toolData} ui={<ZeroWidthSpaceRemoverTool />} related={<RelatedTools currentSlug={toolData.slug} />}>
        {writeUp}
