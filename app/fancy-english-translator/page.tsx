  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <p>If you are preparing text for a design or document, you may use several tools in sequence. For example, paste content from a webpage as plain text first to remove markup, then clean extra spaces and line breaks. Once your base text is clean, run it through the fancy English translator to get the style or wording you want. The site lists all text and generator tools so you can combine fancy text with other creative and formatting workflows.</p>
