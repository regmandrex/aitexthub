  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <p>This free tool takes a list of lines and generates combinations—e.g., every pair of lines, or every set of three. Order can matter or not depending on options. Useful for content ideas, testing data, or teaching combinatorics.</p>

        <h2>How It Works</h2>
        <p>Paste or enter your lines (one per line), choose how many lines per combination and whether order matters, then run. The tool outputs each combination. Processing runs in your browser.</p>

        <h2>Use Cases</h2>
        <p>Use it to combine phrases, generate test cases, create tag pairs, or explore line-based combinations for any list.</p>

        <h2>Limitations</h2>
        <p>Large numbers of lines produce many combinations. Use reasonable list sizes to avoid timeouts or huge output.</p>
      </div>
    </section>
  );
}
