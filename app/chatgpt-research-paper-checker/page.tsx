...
const faqs: FaqItem[] = [
  ...
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'Does this tool check for plagiarism?', answer: 'No, this tool focuses on paper quality, not plagiarism detection. Use dedicated plagiarism checkers like Turnitin alongside this tool. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'Can the tool evaluate methodology?', answer: 'The tool assesses whether methodology is clearly described and appropriate. It cannot evaluate whether methodology was actually followed or results are valid. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  ...
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'Can I check specific sections only?', answer: 'Yes, you can check introduction, literature review, methodology, or other sections separately for focused feedback. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'Does discipline matter?', answer: 'Different disciplines have different conventions. The tool provides general research paper assessment; adjust for your field\'s specific requirements. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'How long can papers be?', answer: 'The tool handles typical research paper lengths. Very long papers may benefit from section-by-section checking. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'What makes a good abstract?', answer: 'Good abstracts concisely summarize research question, methodology, key findings, and significance. The tool evaluates abstract completeness and clarity. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'What makes a good introduction?', answer: 'Good introductions establish context, identify the gap your research addresses, state your thesis/research question, and preview your paper. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'Can AI-generated papers be checked?', answer: 'Yes, the tool evaluates paper quality regardless of origin. It can identify weaknesses in AI-generated research papers. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'Does the tool evaluate argument strength?', answer: 'Yes, the tool assesses whether arguments are logical, well-supported, and clearly developed throughout the paper. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
  ...
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'How should limitations be addressed?', answer: 'Good papers acknowledge limitations honestly. The tool can evaluate whether limitations are adequately discussed. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'What citation styles does this support?', answer: 'The tool recognizes common citation styles (APA, MLA, Chicago, etc.) and may identify formatting inconsistencies. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'Can the tool help with transitions?', answer: 'Yes, the tool evaluates how well sections connect and whether transitions guide readers through your argument. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
  ...
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'What about research questions?', answer: 'The tool evaluates whether research questions are clear, focused, and adequately addressed by the paper. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'Can the tool identify gaps in argumentation?', answer: 'Yes, the tool may identify where arguments lack support or where logical connections are weak. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'Is this suitable for thesis/dissertation work?', answer: 'The tool provides general feedback applicable to thesis work. Very long works may need section-by-section checking. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'What makes a strong conclusion?', answer: 'Strong conclusions summarize findings, address implications, acknowledge limitations, and suggest future research directions. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'How does the tool handle technical content?', answer: 'The tool evaluates clarity and structure of technical content but cannot assess technical accuracy. Domain expertise is needed for that. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
  ...
  { category: 'ChatGPT Research Paper Checker FAQs', question: 'What about conference vs. journal papers?', answer: 'Different venues have different requirements. The tool provides general assessment; adjust for specific venue guidelines. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' }
];
...
const writeUp = (
  <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
    <div className="prose prose-slate max-w-none">
      ...
      <p>AI Text Cleanup Tools provides this research paper checker as a free resource for students and researchers. The tool processes text locally in your browser, ensuring your research remains private.</p>
