...
export default async function ChatGPTOriginalityCheckerPage() {
  ...
  const pageFaqs: FaqItem[] = [
    ...
    { category: 'General', question: 'Is the Originality Checker free?', answer: 'Yes. This tool is free. Paste your text, run the check, and review the result. Processing runs in your browser; your text is not sent to our servers. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
    { category: 'Accuracy', question: 'How accurate is the originality checker?', answer: 'The tool gives an indicative score based on common signals. It is not a substitute for Turnitin, Copyleaks, or other official systems. Use it for pre-screening and revision only. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
    { category: 'Privacy', question: 'Is my text sent to external services or stored?', answer: 'No. The tool runs in your browser. Your text is not sent to third-party detectors or our servers, and it is not stored. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
    { category: 'Usage', question: 'How do I use the ChatGPT Originality Checker?', answer: 'Paste your content into the input area and run the analysis. Review the score and suggestions. Edit your text as needed. For official decisions, use the tools required by your school or employer. That keeps the result useful as a practical pre-check instead of a final judgment.' },
    { category: 'Technical', question: 'What does the tool analyze?', answer: 'The tool looks at factors such as predictability, repetition, and structure that are often associated with AI or low-originality text. It does not access external databases or compare to the whole web. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
    { category: 'Use cases', question: 'Who should use an originality checker?', answer: 'Students, writers, and professionals who want a quick pre-check before submitting to formal systems can use it. It helps you spot potential issues and revise; it does not replace institutional tools. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
    { category: 'Limits', question: 'Does it replace Turnitin or Copyleaks?', answer: 'No. For final originality or plagiarism decisions, use the tools and policies required by your organization. This checker is for pre-screening only. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
    { category: 'General', question: 'Can I check long documents?', answer: 'Typical article and essay lengths are supported. Very long texts may need to be split. Check the tool for current limits. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
    { category: 'SEO', question: 'Is the originality checker useful for publishers?', answer: 'Publishers can use it to get a rough sense of how original or AI-like content might appear. It does not replace editorial or contractual requirements. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
    { category: 'Technical', question: 'Why do different tools give different scores?', answer: 'Each system uses different models and data. This tool gives an approximate indication; it will not match Turnitin, Copyleaks, or others exactly. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
    { category: 'Usage', question: 'Should I revise based on the result?', answer: 'You can use the feedback to improve clarity and variety. Always ensure your work meets your course or employer requirements and disclosure policies. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
    ...
    { category: 'Accuracy', question: 'Will this match my Turnitin or Copyleaks score?', answer: 'No. Different systems use different methods. This tool gives an approximate indication only. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
    ...
    { category: 'Limits', question: 'Is there a word limit?', answer: 'Typical limits are in the thousands of words. Check the tool interface for the current limit. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
    { category: 'General', question: 'Do I need an account?', answer: 'No. You can use the ChatGPT Originality Checker without signing up. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace. If the result matters, save your notes and follow the approved review process.' },
    { category: 'Usage', question: 'How often can I use it?', answer: 'The tool is free to use as often as you need. There is no per-day limit on our side. That keeps the result useful as a practical pre-check instead of a final judgment. Read the result together with your own review and any rules from your school, client, publication, or workplace.' },
