  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <p>This free Old English translator runs in your browser. You enter your text, click translate, and copy the result. No sign-up is required. The tool approximates Old English by swapping in period-appropriate words and forms. In this guide we explain what Old English (Anglo-Saxon) is, how to use an Old English translator, when to use it for study and creative writing, and how it compares to Middle English and Shakespearean translators. For text cleanup and the full tool list, see our <Link href="/">homepage</Link>.</p>

        <h2>What Is Old English (Anglo-Saxon)?</h2>
        <p>Old English, or Anglo-Saxon, is the earliest form of English, used in England from roughly 450 to 1150. It is the language of Beowulf and the Anglo-Saxon Chronicle. An Old English translator does not reproduce historical texts word-for-word; it gives your modern sentences an Anglo-Saxon flavor. For a later period (Chaucer-era), use a <Link href="/middle-english-translator">Middle English translator</Link> or <Link href="/medieval-translator">medieval translator</Link>; for Early Modern (thee, thou), use the <Link href="/shakespearean-translator">Shakespearean translator</Link>.</p>
        ...
        <p>When people say “translate to Anglo Saxon,” they usually mean convert modern English into Old English (Anglo-Saxon) style. Our Old English translator does exactly that. A <Link href="/middle-english-translator">Middle English translator</Link> targets Chaucer-era language (later). The <Link href="/shakespearean-translator">Shakespearean translator</Link> targets Early Modern English (thee, thou). Choose the right tool for your period.</p>
        ...
        <p>If you are preparing text for a story or document, you may use several tools in sequence. Paste content from a webpage into a strip-HTML tool first, then use a space remover to clean extra spaces. Once your text is clean, run it through the Old English translator.</p>

        <h2>Similar Period and Language Translators</h2>
        <p>If you need a different period or style, use our similar translator pages. The <Link href="/medieval-translator">medieval translator</Link> and <Link href="/middle-english-translator">Middle English translator</Link> target Chaucer-era language; the <Link href="/shakespearean-translator">Shakespearean translator</Link> produces Early Modern “thee and thou” style. We also offer a <Link href="/navajo-translator">Navajo translator</Link> for English to Navajo and a <Link href="/fancy-english-translator">fancy English translator</Link> for decorative wording. For the full tool list, see the <Link href="/">homepage</Link>. Each tool fits a different era or use case—pick the one that matches your project.</p>
        ...
        <p>No sign-up or login is required. You can use the tool in a private or incognito window if you prefer. For similar period tools—medieval translator, Middle English translator, Shakespearean translator—and for fancy English or Navajo translator, the homepage has the full list. For cleaning pasted text from the web, use a strip-HTML and space-remover utility before you translate.</p>
        ...
        <p>Old English (Anglo-Saxon) is the earliest of the three. Use a <Link href="/middle-english-translator">Middle English translator</Link> for Chaucer-era language; use the <Link href="/shakespearean-translator">Shakespearean translator</Link> for Early Modern. The Old English translator targets the earliest period. Teachers often use this contrast to show how English changed over time.</p>
        ...
        <p>For best results when you translate to Anglo Saxon: start with clean, plain text. If you pasted from the web, use a strip-HTML and space-remover tool first. Paste into the Old English translator and click translate. Copy the output and edit for rhythm, clarity, and audience. Use the result for creative writing, education, or themed content—not for formal documents. For a different period, try the medieval translator, Middle English translator, or Shakespearean translator; the homepage lists all tools. That keeps the input tidy and the output easier to edit.</p>
...
export default async function OldEnglishTranslatorPage() {
  ...
  const pageFaqs: FaqItem[] = [
    ...
    { category: 'Use cases', question: 'Can I translate from Old English to modern English?', answer: 'This tool focuses on converting modern English into Old English (Anglo-Saxon) style. Some other tools offer reverse conversion from Old English to modern. For cleaning and formatting text before or after you translate, use a space remover or strip-HTML utility.' },
