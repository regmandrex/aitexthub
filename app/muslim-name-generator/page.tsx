  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <p>Your project may need more than one type of name. For example, a novel might have human characters with Islamic-style names (from this Muslim name generator), a fantasy species with binomial names (from the <Link href="/species-name-generator">species name generator</Link>), and mythological figures with deity names (from the <Link href="/god-goddess-name-generator">god and goddess name generator</Link>). Use each tool for its strength: this page for Islamic and Arabic-style human names, and other pages for creature names, deity names, or names from different cultures. When you assemble lists from multiple sources, keep a single naming document and clean pasted text (e.g. with a space remover or strip-HTML step) when pasting from the web so formatting stays consistent. See our <Link href="/">homepage</Link> for the full list.</p>
