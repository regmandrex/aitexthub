...
const writeUp = (
  <section className="prose prose-slate max-w-none">
    ...
    <p>
      Each 512-bit block is processed through a compression function involving 64 rounds. The round function uses six logical functions: Ch(e,f,g), Maj(a,b,c), S0(a), S1(e), s0(w), and s1(w). These combine right-rotation (ROTR), right-shift (SHR), and XOR operations. The message schedule expands each 512-bit block from 16 to 64 words using s0 and s1, ensuring that changes in any input bit propagate through the entire schedule.
    </p>
    <p>
