...
const description = tool?.shortDescription ?? 'Decode Base64 strings back to readable text.';
const title = tool?.title ?? 'Base64 Decode';
...
export default function Base64DecodePage() {
  ...
  return (
    <>
      ...
      <ToolPageShell tool={toolData} ui={<Base64DecodeTool />} related={<RelatedTools currentSlug={toolData.slug} />}>
        {writeUp}
