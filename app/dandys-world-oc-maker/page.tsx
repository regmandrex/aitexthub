...
const pageFaqs: FaqItem[] = [
  ...
  { category: 'Output', question: "Does the Dandy's World OC maker generate an image?", answer: 'Yes. The free first step creates the character concept, and Pro access unlocks one reference-style image based on the selected Toon type, role, colors, materials, outfit, accessory, and personality.' },
