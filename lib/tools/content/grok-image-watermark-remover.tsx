  ...
  return (
    <section className="rounded-2xl border-3 border-black bg-white p-4 shadow-neo-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        ...
        <p className="text-slate-700 mb-4">Click <strong>Clean image</strong> to begin watermark removal. Processing typically completes in a few seconds for standard-resolution images. Download the cleaned file in your preferred format — PNG for lossless output, JPEG for web-optimized delivery. The visual content of the image is preserved exactly: no pixels are changed beyond the pixel-level signal attenuation if that option was selected, and visual quality remains above perceptible thresholds throughout.</p>
