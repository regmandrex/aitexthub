...
const WriteUp = () => (
  <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-6 mt-10"><div className="prose prose-slate max-w-none">
    ...
    <p className="text-slate-700 mb-4">Run each query through ChatGPT multiple times — responses vary due to the model&#39;s probabilistic nature. A brand might appear in 8 out of 10 runs of the same query, giving you an 80% mention rate for that query. Tracking these rates consistently over time shows whether your GEO investments are moving the needle. Do this on a monthly cadence at minimum; more frequent tracking is useful if you&#39;re actively running GEO campaigns and want to see their effect.</p>
...
export const chatgptRankTrackerContent: ToolContent = {
  ...
  faqs: [
    ...
    {
      category: 'general',
      question: 'How many queries should I track for a complete ChatGPT ranking picture?',
    ...
    {
      category: 'general',
      question: 'Is ChatGPT rank tracking relevant for e-commerce brands?',
