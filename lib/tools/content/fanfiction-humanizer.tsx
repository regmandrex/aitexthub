  ...
  return (
    <section className="rounded-2xl border-3 border-black bg-white p-4 shadow-neo-sm md:p-6 mt-10">
      <div className="prose prose-slate max-w-none">
        <h2>AI Fanfiction Humanizer: Making AI-Generated Fanfic Sound Like It Came From a Real Fan</h2>
        <p>
        ...
        <h2>The Culture of Fanfiction: AO3, FFN, Wattpad, and Beyond</h2>
        <p>
        ...
        <h2>Why AI Fanfiction Fails: The OOC Problem and Character Voice</h2>
        <p>
        ...
        <h2>Fanfic Tropes: The Emotional Architecture of Fan Stories</h2>
        <p>
        ...
        <h2>Ship Dynamics: Writing Romantic Relationships That Fandom Believes In</h2>
        <p>
        ...
        <h2>Author&apos;s Notes: The Human Voice Behind the Story</h2>
        <p>
        ...
        <h2>Fandom-Specific Language and Community Conventions</h2>
        <p>
        ...
        <h2>Emotional Authenticity: What Makes Fanfic Feel Real</h2>
        <p>
        ...
        <h2>Prose Style in Fanfiction: Finding the Right Register</h2>
        <p>
        ...
        <h2>How the AI Fanfiction Humanizer Works in Practice</h2>
        <p>
        ...
        <h2>Improving AI Fanfic for AO3 Posting Standards</h2>
        <p>
        ...
        <h2>Genre-Specific Humanization: From Gen to Explicit</h2>
        <p>
        ...
        <h2>Common AI Fanfic Problems: A Diagnostic Guide</h2>
        <p>
        ...
        <h2>Best Practices for Using the AI Fanfiction Humanizer</h2>
        <p>
...
const faqs: FaqItem[] = [
  ...
  {
    category: 'Tropes and Structure',
    question: 'Does the humanizer work for Alternate Universe fanfic?',
    answer: 'Yes. AU fanfic requires characters to feel authentically themselves even in completely different settings. The humanizer identifies where AU versions of characters have lost their essential traits — their core psychology, their relationship patterns, their specific humor — and revises to restore character authenticity within the new setting, so a coffee shop AU feels like it\'s about these specific characters, not generic people with their names.',
  },
  {
    category: 'Tropes and Structure',
    question: 'What about hurt/comfort fics? Why does AI fail at that trope specifically?',
    answer: 'AI hurt/comfort is almost always unsatisfying because it does not understand the specific emotional dynamics of the trope. Good hurt/comfort requires genuine, character-specific suffering, earned and character-appropriate comfort, and an emotional intimacy in the caretaking that advances the relationship in a specific direction. AI makes the hurt generic and the comfort formulaic, missing the emotional permission-giving that is the whole point of the trope.',
  },
  {
    category: 'Character Voice',
    question: 'How does the humanizer fix character voice problems?',
    answer: 'The humanizer analyzes dialogue and interiority for consistency with established character voice. It flags speech using incorrect vocabulary, wrong emotional register, or uncharacteristic directness. It then revises to match the character\'s known communication style — their specific deflections, their humor, their vocabulary range, their patterns of avoiding or engaging with emotional content.',
  },
  {
    category: 'Character Voice',
    question: 'Can the humanizer fix dialogue that makes all characters sound identical?',
    answer: 'Yes. AI dialogue commonly gives every character the same voice and vocabulary. The humanizer differentiates character voices based on their canonical speech patterns, education level, personality type, and established relationships with each other, so each character sounds distinctly themselves rather than like variants of the same AI-generated neutral narrator.',
  },
  {
    category: 'Ship Dynamics',
    question: 'What are ship dynamics and why do they matter so much for fanfic quality?',
    answer: 'Ship dynamics are the specific interplay of personality, history, power balance, and emotional patterns between two characters in a romantic pairing. Every ship has a unique dynamic fans have analyzed extensively. Destiel\'s dynamic is completely different from Johnlock\'s even though both are popular slash ships. AI applies a generic romance template to all ships rather than understanding the specific architecture of each pairing.',
  },
  {
    category: 'Ship Dynamics',
    question: 'My AI fanfic feels like it could be about any two people — not the specific characters. Can humanization fix this?',
    answer: 'This is one of the most common AI fanfic problems. The humanizer addresses it by incorporating ship-specific dynamics — the particular way these two characters interact, their shared history, the specific barriers and connections between them — so the relationship feels like it belongs specifically to these characters rather than being a romance skeleton with their names attached.',
  },
  {
    category: 'Emotional Content',
    question: 'Why does AI fanfic feel emotionally flat even when emotions are being described?',
    answer: 'AI names emotions rather than embodying them. It writes "she felt devastated" instead of the specific, physical, character-particular way devastation manifests in this person. Emotional authenticity in fanfic comes from specificity — the detail that makes readers think "yes, that\'s exactly right, that\'s exactly how they would feel and show it." The humanizer replaces abstract emotion labeling with specific, embodied, character-consistent emotional description.',
  },
  {
    category: 'Emotional Content',
    question: 'The emotional moments in my AI draft feel rushed. Can humanization fix the pacing?',
    answer: 'Yes. Pacing is a common AI failure — emotional moments that need space get rushed, and space is wasted on moments that don\'t need it. The humanizer identifies emotional beats that require more development and expands them while tightening over-padded sections, resulting in pacing that serves the actual emotional priorities of the story rather than just advancing the plot at uniform speed.',
  },
  {
    category: 'Prose Quality',
    question: 'What is purple prose and does AI fanfic have a problem with it?',
    answer: 'Purple prose is overwrought, excessively ornate description that draws attention to itself rather than serving the story. AI fanfic commonly produces it in emotional moments, reaching for dramatic metaphors when specific, restrained description would be more effective. The humanizer identifies and revises purple prose into writing that earns emotional impact through concrete specificity rather than asserting it through extravagant language.',
  },
  {
    category: 'Prose Quality',
    question: 'How does the humanizer handle repetitive sentence structure in AI writing?',
    answer: 'AI writing tends toward monotonous "Character did X. Then Y. Character felt Z." structures without rhythmic variation. The humanizer restructures prose for varied sentence length and rhythm, introducing embedded clauses, participial phrases, and other structural variety that characterizes skilled fan writing and makes the prose feel alive rather than mechanical.',
  },
  {
    category: 'Author\'s Notes',
    question: 'Can the humanizer help me write an authentic author\'s note?',
    answer: 'Yes. Author\'s notes are a crucial part of fanfic culture — they establish your relationship with readers, thank your beta, and share your connection to the material. The humanizer can help craft author\'s notes that use the right conventions: the appropriate mix of enthusiasm, self-deprecating humor, and direct address to the fan community that signals genuine fan participation.',
  },
  {
    category: 'Fandom Language',
    question: 'Does the humanizer understand fandom-specific language and conventions?',
    answer: 'The humanizer is trained on broad fanfic culture conventions and can apply fandom-appropriate language, apply correct content warning conventions, and remove cultural mismatches like Americanisms in British-set fandoms. For highly specific fandom conventions, the writer\'s own knowledge remains essential for the final review pass.',
  },
  {
    category: 'Content Types',
    question: 'Does the humanizer work for both gen fic and explicit content?',
    answer: 'Yes, across all content ratings. For general and teen-rated fic, it focuses on character voice, emotional content, and prose quality. For mature and explicit content, it additionally addresses how fan writers handle physical intimacy — balancing physical description with emotional interiority and ensuring intimacy serves character development rather than existing as an isolated scene.',
  },
  {
    category: 'Practical Use',
    question: 'How long should my fanfic excerpt be when I submit it for humanization?',
    answer: 'The humanizer works on any length, from short one-shots to multi-chapter excerpts. For long fics, processing a chapter at a time produces the best results, as it allows the humanizer to focus on the specific emotional arc of that chapter. Very long submissions may dilute the tool\'s focus on specific problem areas.',
  },
  {
    category: 'Practical Use',
    question: 'Should I give the humanizer context about my fandom and ship?',
    answer: 'Absolutely. The more context you provide — fandom name, characters, ship, tropes being used, platform you\'re posting to, and specific problems you\'ve identified in the draft — the more accurately the humanizer can target the right conventions. A Genshin Impact AO3 slow burn needs very different humanization than a Harry Potter FFN gen fic.',
  },
  {
    category: 'Ethics and Community',
    question: 'Is using an AI fanfiction humanizer considered ethical in fandom spaces?',
    answer: 'This is a genuine debate in fandom communities. Using AI as a drafting tool while ensuring the final product reflects genuine engagement with the characters and source material is different from mass-producing AI fanfic without real fan investment. The humanizer is designed for writers who genuinely love their fandom and want to express that love more effectively through AI-assisted drafts, not for generating content without authentic engagement.',
  },
  {
    category: 'Ethics and Community',
    question: 'Will the humanizer make my fanfic read as fully human-written on AO3?',
    answer: 'The humanizer significantly improves AI fanfic quality and community authenticity. The best results come when a genuine fan uses it as part of their creative process — your own deep fandom knowledge, your real love for the characters, and your final review pass to catch anything still feeling off are what transform the humanized output into genuine fanfiction that participates authentically in fandom.',
  },
];

export const fanfictionHumanizerContent: ToolContent = {
  writeUp: <WriteUp />,
  faqs,
};
